...
void transmitDataString(char data_mode, char addr[4],char rssi[3], char msg[MESSAGE_LENGTH] )
{
 ...
 /* if(!(data_mode & degCMode))
  ...
  if(data_mode & verboseMode)
  {
    ...
    output_verbose[2] = temp_string[0];
    output_verbose[3] = temp_string[1];
    output_verbose[4] = temp_string[2];
    output_verbose[5] = temp_string[3];
  ...
  case 'T':
    ...
    output_short[2] = temp_string[0];
    output_short[3] = temp_string[1];
    output_short[4] = temp_string[2];
    output_short[5] = temp_string[3];
  ...
  case 'H':
    ...
    output_shorth[2] = temp_string[0];
    output_shorth[3] = temp_string[1];
    output_shorth[4] = temp_string[2];
    output_shorth[5] = temp_string[3];
    output_shorth[6] = temp_string[4];
    output_shorth[7] = '%';

    TXString(output_shorth, sizeof output_shorth );
    break;
    
  case 'P':
    char output_shortp[] = {"\r\n-XX.XP"};

    output_shortp[2] = temp_string[0];
    output_shortp[3] = temp_string[1];
    output_shortp[4] = temp_string[2];
    output_shortp[5] = temp_string[3];
    output_shortp[6] = temp_string[4];
    output_shortp[7] = 'P';

    TXString(output_shortp, sizeof output_shortp );
    break;
  }
  }
}
